...
> When a user reports the *"You don't have permission to access this developer portal"* error, see [docs/onboarding-portal-users.md](docs/onboarding-portal-users.md) for the step-by-step runbook to grant access.
